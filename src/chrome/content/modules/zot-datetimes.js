...
if (!Zotero.ZotURead.DateTimes) Zotero.ZotURead.DateTimes = {};

Zotero.ZotURead.DateTimes = Object.assign(Zotero.ZotURead.DateTimes, {
  yyyyMM: 'yyyy-MM',
  yyyyMMdd: 'yyyy-MM-dd',
  ...
  yyyyMMddHHmmssS: 'yyyy-MM-dd HH:mm:ss.S',
	...
	init() {
		Zotero.ZotURead.Logger.log('Zotero.ZotURead.DateTimes inited.');
	},
  ...
  now() {
    return this.formatDate(new Date(), Zotero.ZotURead.DateTimes.yyyyMMddHHmmssS);
  },
