...
if (!Zotero.ZotURead.Doms) Zotero.ZotURead.Doms = {};

Zotero.ZotURead.Doms = Object.assign(Zotero.ZotURead.Doms, {
	init() {
		Zotero.ZotURead.Logger.log('Zotero.ZotURead.Doms inited.');
	},
