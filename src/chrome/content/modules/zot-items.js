...
if (!Zotero.ZotURead.Items) Zotero.ZotURead.Items = {};

Zotero.ZotURead.Items = Object.assign(Zotero.ZotURead.Items, {
	init() {
		Zotero.ZotURead.Logger.log('Zotero.ZotURead.Items inited.');
	},
  ...
  //   let links = [];
	// 	if (collection) {
  //     links.push(...Zotero.ZotURead.Collections.links(collection.id));
	// 	} else if(search) {
  ...
  selectItem(collectionID, itemID) {
    Zotero.ZotURead.Collections.selectCollection(collectionID).then(() => {
  ...
  selectItemFromLibraryAndKey(libraryID, collectionKey, key) {
    ...
    Zotero.ZotURead.Collections.selectCollectionFromLibraryAndKey(libraryID, collectionKey).then(() => {
