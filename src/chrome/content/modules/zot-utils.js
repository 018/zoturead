...
if (!Zotero.ZotURead.Utils) Zotero.ZotURead.Utils = {};

Zotero.ZotURead.Utils = Object.assign(Zotero.ZotURead.Utils, {
	init() {
		Zotero.ZotURead.Logger.log('Zotero.ZotURead.Utils inited.');
	},
  ...
  getCurrentUsername() {
    return Zotero.ZotURead.Prefs.get('sync.server.username', Zotero.Users.getCurrentUsername());
  },
